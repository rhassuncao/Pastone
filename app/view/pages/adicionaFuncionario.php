<?php
    ...
    $funcionario = new Funcionario(NULL, $categoriaFuncionario, $nome, $telefone1, $telefone2, $telefone3, $CEP, $endereco, $numero, $complemento, $pontoReferencia, $bairro, $cidade, $estado,  $RG, $CPF, $dataNascimento, $CTPS, $salario, $valeTransporte, $valeRefeicao, $ativo, NULL, $email, $senha);
    
    $resultado = $CDAO->inserirFuncionario($funcionario);
