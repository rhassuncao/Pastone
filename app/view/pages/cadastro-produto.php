                                ...
                                <div class="col-lg-12">
                                    <?php
                                        ...
                                        if(isset($_GET["id"])){
                                            ...
                                            echo "<form role='form' method='post' action='adicionaProduto.php'>
                                                ...
                                                <div class='row'>
                                                    <div class='col-lg-12'>
                                                        <div class='form-group'>
                                                            ...
                                                            <textarea maxlength='255' required class='form-control' name='descricao'rows='3'></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class='row'>
                                                    <div class='col-lg-2'>
                                                        <div class='form-group'>
                                                            <label>Valor*</label>
                                                            <input maxlength='8' type='number' step='0.01' min='0' required name='preco' class='form-control'>
                                                        </div>
                                                    </div>
                                                    <div class='col-lg-10'>
                                                        <div class='form-group'>
