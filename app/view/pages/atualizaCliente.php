<?php
	...
	$cliente = new Cliente($id, $nome, $telefone1, $telefone2, $telefone3, $cep, $endereco, $numero, $complemento, $pontoReferencia, $bairro, $cidade, $estado, $ativo, NULL, $observacao);
    
    $resultado = $CDAO->atualizarCliente($cliente);
